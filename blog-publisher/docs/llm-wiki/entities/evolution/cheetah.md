# 엔티티 — cheetah 진화 이력 (현재 v2)

> cheetah(트렌드 주제 수집) 에이전트의 EVOLVE-BLOCK 버전 연표. SEED:locked·frontmatter 변경은 기록하지 않는다(영구 불변).
> 자가발전 메커니즘 일반은 [../../concepts/self-evolution.md](../../concepts/self-evolution.md).

- **역할**: 트렌드 주제 수집
- **단계**: 1
- **현재 버전**: v2
- **정의 파일**: `.claude/agents/cheetah.md`

## 버전 연표

| 버전 | 날짜 | 주요 변경(EVOLVE-BLOCK) | 트리거 | 출처(iter/commit) |
|------|------|------------------------|--------|------------------|
| v1 | 2026-06-26 | 초기 트렌드 수집 계약 | 프로젝트 시작 | Phase1 MVP (9a0c255) |
